...
function UserProfile() {
  return (
    <div className="bg-purple-100 flex justify-center align-center md:h-[90vh] h-[100vh] text-[white]">
      <div className="w-[90%]  h-[100%] flex justify-between align-center">
        ...
        <div className="md:w-[80%] w-[60%] flex justify-center items-center rounded-[20px]">
          <div className="md:w-[90%] w-[90%]  h-[90%] bg-[#5D3578] rounded-[20px]">
            <Outlet />
          </div>
        </div>
      </div>
