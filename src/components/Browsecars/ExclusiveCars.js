...
{exclusive?.results?.slice(skip, skip + PER_PAGE).map((exclusive, index) => {
    return(

<div className=" md:w-[100%] md:h-[100%] h-[250px] bg-gray-200 md:bg-inherit  rounded-[20px] flex items-center justify-center " key={`${exclusive.id}_${index}`}>
...
<div className=" md:w-full w-[65%] md:h-[100%] h-[100%] flex items-center justify-center">
    <div className="w-[100%]  h-[100%] flex items-center justify-center">
       <img src={exclusive.picture.medium} className="md:w-full w-[100%] h-[100%] md:rounded-[15px]" alt="" />
          </div>
          </div>
