...
{car?.results?.slice(skip, skip + PER_PAGE).map((each) => {
    return(

<div className=" md:w-[100%] md:h-[100%] h-[300px] bg-gray-200 md:bg-inherit  rounded-[20px] flex items-center justify-center " key={each.car} >
