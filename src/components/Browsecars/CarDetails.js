    ...
    <div className="w-full ">
      {product && (
        <div className=" flex justify-center pt-8 flex-col bg-gradient-to-r from-purple-600 to-pink-600">
          ...
          <div className="w-[100%] h-[50%] bg-white text-black text-center flex justify-center items-center ">
            <div className="">
              <div>
                <h1> {product.name}</h1>
              </div>
              <div className="flex">
                ...
                <h2 className="mx-4">Location: {product.location}</h2>
              </div>
            </div>
          </div>{" "}
          <div className="flex justify-center items-center py-8 md:flex-row flex-col  w-[100%] h-[100%] ">
            <div className="w-[80%]">
              {" "}
