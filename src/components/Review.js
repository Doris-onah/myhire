      ...
      <div className="review-section w-[90%] flex flex-col justify-center items-center">
        <div className="review-header">
          <div className="review-header-content text-white">
            <h1 className="md:block hidden text-4xl">
        ...
        <div className="review-box ">
          ...
          <div className="review-con2 ">
            ...
            <div className="review-content">
              <p>
                “I had a great experience with this company. The staff was very
                friendly and helpful. I would definitely recommend this company
                to anyone looking to rent a car.”
              </p>
            </div>
          </div>
