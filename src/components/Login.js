          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <span ><h1 className="text-xl font-bold  text-white md:text-2xl ">
                ...
                <p className="text-base text-gray-300 md:text-lg">
                    Login My Details</p></span>
              <form className="space-y-4 md:space-y-6  md:w-[600px]" action="#">
                    {/* this is the email section */}
                  <div>
                      <input type="email" name="email" id="email"
                       className="bg-gray-50 h-[60px] border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  ...
                  className=" font-medium text-white dark:text-primary-500">
                      ...
                      Don’t have an account yet? <Link to="/Register" className="font-medium text-white">Sign up</Link>
                  </p>
                      </div>
                  </div>
              </form>
